...
public class CastReceiver : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        //checkLeft.transform.parent = GameObject.Find("Origin").transform;
        //checkRight.transform.parent = GameObject.Find("Origin").transform;
    ...
    void Update()
    {
        if(this.Instance.ReceiveDataLeft && this.Instance.ReceiveDataRight)
        {
            ...
            //checkLeft.transform.localPosition = Instance.lastFixtureTipTransform_left.position;
            //checkRight.transform.localPosition = Instance.lastFixtureTipTransform_right.position;
